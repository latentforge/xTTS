...
from xTTS.tts.layers.feed_forward.decoder import Decoder
from xTTS.tts.layers.feed_forward.encoder import Encoder
from xTTS.tts.layers.generic.aligner import AlignmentNetwork
from xTTS.tts.layers.generic.pos_encoding import PositionalEncoding
from xTTS.tts.layers.glow_tts.duration_predictor import DurationPredictor
from xTTS.tts.models.base_tts import BaseTTS
from xTTS.tts.utils.helpers import average_over_durations, generate_path, maximum_path, sequence_mask
from xTTS.tts.utils.speakers import SpeakerManager
from xTTS.tts.utils.text.tokenizer import TTSTokenizer
from xTTS.tts.utils.visual import plot_alignment, plot_avg_energy, plot_avg_pitch, plot_spectrogram
...
class ForwardTTS(BaseTTS):
    ...
    Examples:
        >>> from xTTS.tts.models.fast_pitch import ForwardTTS, ForwardTTSArgs
    ...
    def get_criterion(self):
        from xTTS.tts.layers.losses import ForwardTTSLoss  # pylint: disable=import-outside-toplevel
