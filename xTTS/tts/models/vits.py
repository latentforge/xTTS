...
from xTTS.tts.configs.shared_configs import CharactersConfig
from xTTS.tts.datasets.dataset import TTSDataset, _parse_sample
from xTTS.tts.layers.glow_tts.duration_predictor import DurationPredictor
from xTTS.tts.layers.vits.discriminator import VitsDiscriminator
from xTTS.tts.layers.vits.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from xTTS.tts.layers.vits.stochastic_duration_predictor import StochasticDurationPredictor
from xTTS.tts.models.base_tts import BaseTTS
from xTTS.tts.utils.fairseq import rehash_fairseq_vits_checkpoint
from xTTS.tts.utils.helpers import generate_path, maximum_path, rand_segments, segment, sequence_mask
from xTTS.tts.utils.languages import LanguageManager
from xTTS.tts.utils.speakers import SpeakerManager
from xTTS.tts.utils.synthesis import synthesis
from xTTS.tts.utils.text.characters import BaseCharacters, BaseVocabulary, _characters, _pad, _phonemes, _punctuations
from xTTS.tts.utils.text.tokenizer import TTSTokenizer
from xTTS.tts.utils.visual import plot_alignment
from xTTS.utils.io import load_fsspec
from xTTS.utils.samplers import BucketBatchSampler
from xTTS.vocoder.models.hifigan_generator import HifiganGenerator
from xTTS.vocoder.utils.generic_utils import plot_results
...
class Vits(BaseTTS):
    ...
    def get_criterion(self):
        ...
        `train_step()`"""
        from xTTS.tts.layers.losses import (  # pylint: disable=import-outside-toplevel
    ...
    def load_fairseq_checkpoint(
        ...
        from xTTS.tts.utils.text.cleaners import basic_cleaners
