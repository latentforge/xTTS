...
from xTTS.tts.layers.align_tts.mdn import MDNBlock
from xTTS.tts.layers.feed_forward.decoder import Decoder
from xTTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
from xTTS.tts.utils.helpers import generate_path, maximum_path, sequence_mask
from xTTS.tts.utils.speakers import SpeakerManager
from xTTS.tts.utils.text.tokenizer import TTSTokenizer
from xTTS.tts.utils.visual import plot_alignment, plot_spectrogram
...
class AlignTTS(BaseTTS):
    ...
    Examples:
        >>> from xTTS.tts.configs.align_tts_config import AlignTTSConfig
    ...
    def get_criterion(self):
        from xTTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
