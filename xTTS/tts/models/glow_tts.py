...
from xTTS.tts.configs.glow_tts_config import GlowTTSConfig
from xTTS.tts.layers.glow_tts.decoder import Decoder
from xTTS.tts.layers.glow_tts.encoder import Encoder
...
class GlowTTS(BaseTTS):
    ...
    Examples:
        ...
        >>> from xTTS.tts.configs.glow_tts_config import GlowTTSConfig
        >>> from xTTS.tts.models.glow_tts import GlowTTS
    ...
    @staticmethod
    def get_criterion():
        from xTTS.tts.layers.losses import GlowTTSLoss  # pylint: disable=import-outside-toplevel
