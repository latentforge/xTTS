...
from xTTS.tts.datasets.dataset import F0Dataset, TTSDataset, _parse_sample
from xTTS.tts.layers.delightful_tts.acoustic_model import AcousticModel
from xTTS.tts.layers.losses import ForwardSumLoss, VitsDiscriminatorLoss
from xTTS.tts.layers.vits.discriminator import VitsDiscriminator
from xTTS.tts.models.base_tts import BaseTTSE2E
from xTTS.tts.utils.helpers import average_over_durations, compute_attn_prior, rand_segments, segment, sequence_mask
from xTTS.tts.utils.speakers import SpeakerManager
from xTTS.tts.utils.text.tokenizer import TTSTokenizer
from xTTS.tts.utils.visual import plot_alignment, plot_avg_pitch, plot_pitch, plot_spectrogram
from xTTS.utils.audio.numpy_transforms import build_mel_basis, compute_f0
from xTTS.utils.audio.numpy_transforms import db_to_amp as db_to_amp_numpy
from xTTS.utils.audio.numpy_transforms import mel_to_wav as mel_to_wav_numpy
from xTTS.utils.audio.processor import AudioProcessor
from xTTS.utils.io import load_fsspec
from xTTS.vocoder.layers.losses import MultiScaleSTFTLoss
...
class DelightfulTTS(BaseTTSE2E):
    ...
    Examples:
        >>> from xTTS.tts.models.forward_tts_e2e import ForwardTTSE2e, ForwardTTSE2eConfig
