...
from xTTS.tts.configs.shared_configs import BaseTTSConfig
from xTTS.tts.layers.bark.model import GPTConfig
from xTTS.tts.layers.bark.model_fine import FineGPTConfig
from xTTS.tts.models.bark import BarkAudioConfig
