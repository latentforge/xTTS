...
from xTTS.config import load_config, register_config
from xTTS.tts.utils.text.characters import parse_symbols
from xTTS.utils.generic_utils import get_experiment_folder_path, get_git_branch
...
def process_args(args, config=None):
    ...
    if config is None:
        if args.config_path:
            ...
            from xTTS.config.shared_configs import BaseTrainingConfig  # pylint: disable=import-outside-toplevel
