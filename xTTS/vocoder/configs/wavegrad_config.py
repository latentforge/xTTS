...
from xTTS.vocoder.configs.shared_configs import BaseVocoderConfig
from xTTS.vocoder.models.wavegrad import WavegradArgs
...
class WavegradConfig(BaseVocoderConfig):
    ...
    Args:
        ...
        generator_model (str): One of the generators from xTTS.vocoder.models.*`. Every other non-GAN vocoder model is
