...
from xTTS.tts.utils.visual import plot_spectrogram
from xTTS.utils.audio import AudioProcessor
from xTTS.utils.audio.numpy_transforms import mulaw_decode
from xTTS.utils.io import load_fsspec
from xTTS.vocoder.datasets.wavernn_dataset import WaveRNNDataset
from xTTS.vocoder.layers.losses import WaveRNNLoss
from xTTS.vocoder.models.base_vocoder import BaseVocoder
from xTTS.vocoder.utils.distribution import sample_from_discretized_mix_logistic, sample_from_gaussian
...
class Wavernn(BaseVocoder):
    def __init__(self, config: Coqpit):
        ...
        Examples:
            >>> from xTTS.vocoder.configs import WavernnConfig
