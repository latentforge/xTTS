...
from xTTS.vocoder.datasets.gan_dataset import GANDataset
from xTTS.vocoder.layers.losses import DiscriminatorLoss, GeneratorLoss
from xTTS.vocoder.models import setup_discriminator, setup_generator
...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit, ap: AudioProcessor = None):
        ...
        Examples:
            ...
            >>> from xTTS.vocoder.configs import HifiganConfig
