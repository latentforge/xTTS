...
from xTTS.vocoder.datasets import WaveGradDataset
from xTTS.vocoder.layers.wavegrad import Conv1d, DBlock, FiLM, UBlock
...
class Wavegrad(BaseVocoder):
    ...
    Examples:
        ...
        >>> from xTTS.vocoder.configs import WavegradConfig
