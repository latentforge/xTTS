...
from xTTS.vc.configs.freevc_config import FreeVCConfig
from xTTS.vc.models.base_vc import BaseVC
from xTTS.vc.modules.freevc.commons import get_padding, init_weights
from xTTS.vc.modules.freevc.mel_processing import mel_spectrogram_torch
from xTTS.vc.modules.freevc.speaker_encoder.speaker_encoder import SpeakerEncoder as SpeakerEncoderEx
from xTTS.vc.modules.freevc.wavlm import get_wavlm
...
class FreeVC(BaseVC):
    ...
    Examples:
        >>> from xTTS.vc.configs.freevc_config import FreeVCConfig
        >>> from xTTS.vc.models.freevc import FreeVC
        >>> config = FreeVCConfig()
        >>> model = FreeVC(config)
    """
